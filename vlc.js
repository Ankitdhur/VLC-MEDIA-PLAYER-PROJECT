...
const acceptInputHandler = (obj) => {
    let selectedVideo;
    if(obj.target.files[0].type=="video/mp4" || obj.target.files[0].type=="video/quicktime" || obj.target.files[0].type=="video/x-flv" || obj.target.files[0].type=="video/x-msvideo"|| obj.target.files[0].type=="video/x-matroska" || obj.target.files[0].type=="video/webm"){
